...
<body> 
    ...
    <div class="card" style="background: white">
      <div class="cardText" style="text-align: right;">
        ...
        <h2 style="font-weight: 600;">The best way to protect your data for us is not taking it out of your iPhone. You are totally in charge of your data and you can delete itwhenever you want.</h2>
        <br>
      </div>
    </div>
</body>
